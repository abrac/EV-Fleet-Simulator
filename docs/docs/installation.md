...
|-------------|:------------:|------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *SUMO [^1]  |   == 1.8.0   | [->](https://www.eclipse.org/sumo/)                  | Traffic mobility simulator. Once installed, make sure that the SUMO_HOME environment variable exists. [^0]                                                                                                                                                                               |
| *Python     |     > 3.8    | [->](https://www.python.org/)                        | An awesome, easy-to-learn programming language named after a dangerous snake. Windows users: Make sure you tick the "Add Python to PATH" checkbox during installation!!! [^5]                                                                                                            |
| *Git        |      Any     | [->](http://git-scm.com/)                            | A tool to collaborate on coding projects and track changes that we make.                                                                                                                                                                                                                 |
...
| *SAM        | > 2020.11.29 | [->](https://sam.nrel.gov/)                          | Simulator of Renewable-Energy Generators (Solar panels, wind-turbines, etc.).                                                                                                                                                                                                            |
| +R          |    > 4.0.4   | [->](https://cran.r-project.org/)                    | R programming language. Only compulsory if you plan on running scenarios which use [GTFS data](https://gtfs.org/).                                                                                                                                                                       |
| +osmium     |    > 1.13    | [->](https://osmcode.org/osmium-tool/)               | Software for cropping OpenStreetMap files. Compulsory on Linux and MacOS.                                                                                                                                                                                                                |
| +osmconvert |      Any     | [->](https://wiki.openstreetmap.org/wiki/Osmconvert) | Alternative software for cropping OpenStreetMap files. Compulsory on Windows.                                                                                                                                                                                                            |
| *Pigz       |      Any     | Links in description.                                | Software for compressing files using multiple cpu threads. On Linux, install pigz with your package manager. On Windows, install pigz from [^2], and make sure it is in your system's PATH!! [^3] In MacOS, install MacPorts [^4], and then install Pigz using: `sudo port install pigz` |
